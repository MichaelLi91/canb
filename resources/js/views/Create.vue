<template>
  <div class="h-full bg-light py-4">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-6 border-right mb-4" id="canvas_area">
        ...
        <div class="col-sm-12 col-md-6 heighted">
       <!-- Icons -->
          <div class="row mb-3">
            <div class="col-sm-12">
...
export default {
  ...
  data() {
    return {
     caseImages:{
        ...
        3:{
          0:require("../../assets/cases/iPhone5.png"),
          1:require("../../assets/cases/iPhone6-7-8.png"),
          2:require("../../assets/cases/iPhone6-7-8PLUS.png"),
          3:require("../../assets/cases/iPhone6-7-8.png"),
          4:require("../../assets/cases/iPhone6-7-8PLUS.png"),
          5:require("../../assets/cases/iPhoneX.png"),
          6:require("../../assets/cases/iPhoneX.png"),
        },
        4:{
        ...
        7:{
          0:require("../../assets/cases/Folding.png"),
          1:require("../../assets/cases/hand mirror.png"),  
          2:require("../../assets/cases/keycase.png"),  
          3:require("../../assets/cases/mousepad.png"),  
          4:require("../../assets/cases/namecard holder.png"),  
          5:require("../../assets/cases/Smartphone ring.png"),  
          6:require("../../assets/cases/USB-adapter.png"),  
          7:require("../../assets/cases/Wireless charger.png"),  
        },
      },
      saveid:null,
      isloading:false,
  ...
  mounted() {
    let area_width = document.getElementById("canvas_area").clientWidth;
    let area_height = area_width * 1.3333333;
    this.configKonva.width = area_width;
    this.configKonva.height = area_height;
    ...
    image.onload = () => {
      ...
      if (width >= height) {
        this.image.width = area_width;
        this.image.height = height / width * area_width;
      } else {
        this.image.width = width / height * area_height;
        this.image.height = area_height;
      }
    };
